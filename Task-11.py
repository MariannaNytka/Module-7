...
class Iterable:
    def __init__(self, max_vectors, max_points):
        ...
        for _ in range(max_vectors):
            start_point = Point(randrange(max_points), randrange(max_points))
            end_point = Point(randrange(max_points), randrange(max_points))
            vector = Vector(Point(end_point.x - start_point.x, end_point.y - start_point.y))
